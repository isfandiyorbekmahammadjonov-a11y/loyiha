...
function PostsInfo() {
  return (
    <>
      <div className="flex justify-between px-[352px] mt-[256px] mb-12">
        <div>
      ...
      <div className="flex justify-center gap-8 mb-32">
        {blogPostsBlogify.map((item) => {
          return (
            <div
              key={item.id}
              className="max-w-[360px] bg-white border border-gray-100 rounded-[24px] shadow-sm overflow-hidden font-sans"
            >
