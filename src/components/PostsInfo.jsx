...
function PostsInfo() {
  return (
    <div className="container mx-auto px-6">
      ...
      <div className="md:flex block justify-center gap-18 mb-32">
        {blogPostsBlogify.map((item) => {
          return (
            <div
              key={item.id}
              className="max-w-[360px] mx-auto mb-5 bg-white border border-gray-100 rounded-[24px] shadow-sm overflow-hidden font-sans"
            >
